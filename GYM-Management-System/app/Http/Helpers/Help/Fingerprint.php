...
{
    /**
     * Retrieve fingerprint data for a specific user from the ZKT_KALPER device.
     *
    ...
    static public function get(ZKT_KALPER $self, $uid)
    {
    ...
    /**
     * Set fingerprint data for a specific user on the ZKT_KALPER device.
     *
     * @param ZKT_KALPER $self The instance of the ZKT_KALPER class.
     ...
     */
    static public function set(ZKT_KALPER $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
    ...
    /**
     * Remove fingerprint data for a specific user from the ZKT_KALPER device.
     *
     * @param ZKT_KALPER $self The instance of the ZKT_KALPER class.
     * @param int $uid Unique Employee ID in ZK device.
     ...
     */
    static public function remove(ZKT_KALPER $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
    ...
    static public function cancelCapture(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;

        $command = Util::CMD_CANCELCAPTURE;
        return $self->_command($command, '');
    }

    /**
     * Retrieve fingerprint data for a specific user and finger from the ZKT_KALPER device.
     *
     * @param ZKT_KALPER $self The instance of the ZKT_KALPER class.
     * @param int $uid Unique Employee ID in ZK device.
     ...
     */
    private function _getFinger(ZKT_KALPER $self, $uid, $finger)
    {
    ...
    /**
     * Set fingerprint data on the ZKT_KALPER device.
     *
     * @param ZKT_KALPER $self The instance of the ZKT_KALPER class.
     ...
     */
    private function _setFinger(ZKT_KALPER $self, $data)
    {
    ...
    /**
     * Remove fingerprint data from the ZKT_KALPER device.
     *
     * @param ZKT_KALPER $self The instance of the ZKT_KALPER class.
     * @param int $uid Unique Employee ID in ZK device.
     * @param int $finger Finger ID (0-9).
     ...
     */
    private function _removeFinger(ZKT_KALPER $self, $uid, $finger)
    {
    ...
    /**
     * Check if fingerprint data exists for a specific user and finger on the ZKT_KALPER device.
     *
     * @param ZKT_KALPER $self The instance of the ZKT_KALPER class.
     * @param int $uid Unique Employee ID in ZK device.
     * @param int $finger Finger ID (0-9).
     ...
     */
    private function _checkFinger(ZKT_KALPER $self, $uid, $finger)
    {
        $fingerPrint = new Fingerprint();
