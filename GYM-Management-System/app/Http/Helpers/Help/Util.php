...
class Util
{
  ...
  const CMD_CANCELCAPTURE = 62; # Start to enroll some user, ensure the machines to be at the registration user condition
   ...
   * @return bool|number
   */
  static public function getSize(ZKT_KALPER $self)
  {
   ...
   * @return string
   */
  static public function recData(ZKT_KALPER $self, $maxErrors = 10, $first = true)
  {
    $data = '';
   ...
   * @param int $bytes
   */
  static private function logReceived(ZKT_KALPER $self, $received, $bytes)
  {
   ...
   * @param string $str
   */
  static private function logger(ZKT_KALPER $self, $str)
  {
