...
{
  /**
   * Fetches attendance data from the ZKT_KALPER device.
   *
   * This method retrieves attendance records from the connected ZKT_KALPER device.
   *
  ...
  /**
   * Clears attendance data from the ZKT_KALPER device.
   *
   * This method sends a command to the ZKT_KALPER device to clear all stored attendance records.
   *
   * @param ZKT_KALPER $self An instance of the ZKT_KALPER class.
