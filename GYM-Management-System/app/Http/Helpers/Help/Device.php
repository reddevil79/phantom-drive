...
class Device
{
     ...
     */
    static public function name(ZKT_KALPER $self)
    {
     ...
     */
    static public function enable(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    static public function disable(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function powerOff(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function restart(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function sleep(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function resume(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
    ...
    public static function unlockDoor(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;

        $command = Util::CMD_UNLOCK;
        $command_string = pack("I", 20);
        $cmd_response = $self->_command($command, $command_string);
        return 'succ';
...
//        return $self->_command($command, $command_string);
     ...
     */
    public static function testVoice(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function clearLCD(ZKT_KALPER $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function writeLCD(ZKT_KALPER $self, $rank, $text)
    {
        $self->_section = __METHOD__;
