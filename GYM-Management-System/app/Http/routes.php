...
Route::group(['prefix' => 'members', 'middleware' => ['auth']], function () {
    ...
    Route::get('{id}/registerFP', ['middleware' => ['permission:manage-gymie|manage-members|edit-member'], 'uses' => 'MembersController@registerFP']);
    Route::post('{id}/archive', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@archive']);
    Route::get('{id}/setUser', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@setUser']);
    Route::get('{id}/revokeUser', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@revokeUser']);
    Route::get('{id}/grantAccess', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@grantAccess']);
    Route::get('{id}/cancelFPreg', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@cancelFPreg']);
    Route::get('/unlockDoor', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@unlockDoor']);
    Route::get('{id}/checkFP', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@checkFP']);
    Route::get('{id}/saveFP', ['middleware' => ['permission:manage-gymie|manage-members|delete-member'], 'uses' => 'MembersController@saveFP']);
...
//Device
Route::group(['prefix' => 'device', 'middleware' => ['permission:manage-gymie|manage-users', 'auth']], function () {
    Route::get('/', 'DeviceController@index');
    Route::get('create', 'DeviceController@create');
    Route::post('/', 'DeviceController@store');
    Route::get('{id}/edit', 'DeviceController@edit');
    Route::get('{id}/restart', 'DeviceController@restart');
    Route::post('{id}/update', 'DeviceController@update');
    Route::post('{id}/delete', 'DeviceController@deleteUser');
});
...
Route::group(['prefix' => 'user', 'middleware' => ['permission:manage-gymie|manage-users', 'auth']], function () {
    ...
    Route::get('{id}/enrollUserFP', 'AclController@enrollUserFP');
    Route::get('{id}/revokeUser', 'AclController@revokeUser');
