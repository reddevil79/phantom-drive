...
class Utilities
{
    ...
    public static function Sms($sender_id, $member_contact, $sms_text, $sms_status)
    {
        ...
        $gymName = self::getSetting('gym_name');
...
//            if ($gatewayStatus) {
                ...
                $api_url = 'https://sms.aakashsms.com/sms/v3/send?auth_token='.$api_key.'&to='.$contacts.'&text='.$send_sms_text.'. '. $gymName;
//                $api_url = 'https://sms.aakashsms.com/sms/v3/send?auth_token=514a2f76b8111e676c15ef671b23d2ba77b54277adb2e125b0aca842d6f16871&to=9818411728&text='.$send_sms_text;
                ...
                if (!$responseObj["error"]) {
                    ...
                    $SmsLogData = ['shoot_id' => $responseObj['data']['valid'][0]["id"],
                                        'number' => $responseObj['data']['valid'][0]["mobile"],
                                        'message' => $responseObj['data']['valid'][0]["text"],
                                        'sender_id' => $responseObj['data']['valid'][0]["credit"],
                                        'send_time' => Carbon::now(),
                                        'status' => $responseObj['data']['valid'][0]["status"], ];
