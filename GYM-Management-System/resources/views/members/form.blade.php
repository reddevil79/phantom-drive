...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            {!! Form::select('access',array('2' => 'Ground Floor', '3' => 'First Floor', "3, 2" => 'All Floor', '1' => 'Expired'),null,['class'=>'form-control selectpicker show-tick show-menu-arrow', 'id' => 'access']) !!}
        </div>
    </div>
{{--    <div class="col-sm-6">--}}
{{--        <div class="form-group">--}}
