                            ...
                            @else
                                <table id="members" class="table table-bordered table-striped">
                                    ...
                                    @foreach ($members as $member)
                                        ...
                                        ?>
                                        <tr>
                                            <td><a href="{{ action('MembersController@show',['id' => $member->id]) }}"><img src="{{ $profileImage }} "width="50px"/></a></td>
...
{{--                                                    @if ($saveShow == 'true')--}}
                                                        <a class="" href="{{ action('MembersController@saveFP',['id' => $member->id]) }}">{{(App\MemberTemplate::where('member_id', $member->id)->first()) == null ? "Save" : null}}</a>
{{--                                                    @else--}}
{{--                                                    @endif--}}
