...
<head>
    ...
    <title>Aurora</title>
    <link rel="icon" href="{{ URL::asset('assets/img//web/fab.png') }}">
...
<div id="loadingModal" class="modal fade in" role="dialog" aria-hidden="false" style=" padding-right: 13px; background: #000000e3;
    z-index: 10000;">
    <div class="modal-dialog">

        <!-- Modal content-->
        <div class="modal-content no-border no-shadow" style="background: none">



                <lottie-player src="{{ URL::asset('assets/lottie/loading.json') }}" background="transparent"  speed="1"  style="width: 100%; height: 100%;" loop  autoplay></lottie-player>
...
<header class="hidden-print">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <button class="navbar-btn btn btn-success" onclick="unlockDoor()" style="float: right; margin-right: 10px;">
...
<div class="wrapper">
    <!-- BEGIN LEFTSIDE -->
    <div class="leftside bg-primary hidden-print">
        <div class="sidebar">
            <!-- BEGIN RPOFILE -->
            <div class="nav-profile">
                <div class="thumb">
                    ...
                    $image = ($media->isEmpty() ? 'https://cdn-icons-png.flaticon.com/512/10337/10337609.png' : url($media[0]->getUrl('thumb')));
                    ?>
            ...
            <!-- <li class="nav-dropdown {{-- Utilities::setActiveMenu('reports*',true) --}}">
                ...
                @permission(['manage-gymie','manage-users'])
                <li class="nav-dropdown {{ Utilities::setActiveMenu('device*',true) }}">
                    <a href="#">
                        <i class="fa fa-users"></i> <span>Device</span>
                    </a>
                    <ul>
                        <li class="{{ Utilities::setActiveMenu('device') }}"><a href="{{ action('DeviceController@index') }}"><i class="fa fa-upload"></i> All
                                Devices</a></li>
                        <li class="{{ Utilities::setActiveMenu('device/create') }}"><a href="{{ action('DeviceController@create') }}"><i class="fa fa-list"></i>
                                Add new device</a></li>
...
<script>
    function  unlockDoor(){
        ...
        $.ajax({
            url: '{{ action('MembersController@unlockDoor')}}',
            type: 'get',
            data: {},
