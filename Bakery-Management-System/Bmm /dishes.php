                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-7 col-md-8 col-lg-9">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">Our Products</h3>
                                <div class="clearfix"></div>
                            </div>

                            <div class="product-container">
                                <?php
                                $stmt = $db->prepare("SELECT * FROM product_list");
                                $stmt->execute();
                                ...
                                ?>
                                        <div class="product-card">
                                            ...
                                            <div class="product-details">
                                                ...
                                                <form method="post" action='dishes.php?action=add&id=<?php echo $product['product_id']; ?>' class="product-actions">
