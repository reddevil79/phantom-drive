...
<img src="<?php echo $image_url; ?>" alt="Image" style="height: 50px; width:50px">
    ...
    <td class="py-0 px-1 text-center">
        <?php 
        if($row['status'] == 1){
            echo  '<span class="py-1 px-3 badge rounded-pill bg-success"><small>Popular</small></span>';
        }else{
            echo '<span class="py-1 px-3 badge rounded-pill" style="background-color: red;"><small>Unpopular</small></span>';
