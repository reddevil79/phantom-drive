    ...
    <div class="card-body">
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                ...
                $user_qry = $conn->query("SELECT user_id, email FROM user_list where user_id in (SELECT user_id FROM  `transaction_list` where date(date_added) between '{$dfrom}' and '{$dto}' {$user_where}) ");
                $user_arr = array_column($user_qry->fetch_all(MYSQLI_ASSOC),'email','user_id');
...
<script>
    $(function(){
        ...
        $('#print').click(function(){
            ...
            el.append("<div class='text-center lh-1 fw-bold'>Sales Report<br/>As of<br/>"+date_range+"</div><hr/>")
