...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Bakery Management System</title>
        ...
        Donut Pasal
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <?php ?>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'sales')? 'active' : '' ?>" href="./?page=sales">Transactions</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'customer')? 'active' : '' ?>" aria-current="page" href="./?page=customer">Customer</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'online_orders')? 'active' : '' ?>" href="./?page=online_orders">Online Orders</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=maintenance">Category</a>
                    </li>
                    <?php ?>
