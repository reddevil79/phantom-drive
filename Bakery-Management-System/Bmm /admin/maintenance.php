...
<div class="card h-100 d-flex flex-column rounded-0 shadow">
    ...
    <div class="card-body flex-grow-1">
        <div class="col-12 h-100">
            <div class="row h-100">
                <div class="col-md-6 h-100 d-flex flex-column" style="position: relative;left: 315px;">
                    <div class="w-100 d-flex border-bottom border-dark py-1 mb-1">
                        <div class="fs-2 col-auto flex-grow-1 "><b>Category List</b></div>
                        <div class="col-auto flex-grow-0 d-flex justify-content-end">
                            <a href="javascript:void(0)" id="new_category" class="btn btn-dark btn-sm bg-gradient rounded-2" title="Add Category"><span class="fa fa-plus" style="width: 80px; height: 35px;"
></span></a>
                        </div>
                    </div>
                                ...
                                <div class="col-auto pe-2">
                                    <?php 
                                        if(isset($row['status']) && $row['status'] == 1){
                                            ...
                                            echo '<span class="py-1 px-3 badge rounded-pill" style="background-color: red;"><small>Inactive</small></span>';
                                        }
                                    ?>
                                </div>
