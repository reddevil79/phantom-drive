...
<div class="container-fluid">
    <div id="outprint_receipt">
        <div class="text-center fw-bold lh-1">
            <span>Bakery Management System</span><br>
            <br>
        </div>
    ...
    <a href="PDF.php?MST_ID=<?php echo $transaction_id; ?>" class="btn btn-sm btn-success me-2 rounded-0"><i class="fa fa-download"></i> Download</a>
