                            ...
                            <div class="flex-grow-1" >
                                <div class="h-100 overflow-auto" style="height:60vh !important ">
                                    <table class="table table-hover table-striped bg-light" id="plist">
                                        ...
                                        <tbody>
                                        <?php 
                                        $sql = "SELECT p.*,c.name as cname FROM `product_list` p inner join `category_list` c on p.category_id = c.category_id where p.delete_flag = 0 order by p.`name` asc";
                                        $qry = $conn->query($sql);
                                        ...
                                        <img src="<?php echo $image_url; ?>" alt="Image" style="height: 50px; width:50px">
                                            ...
                                            <td class="td py-0 px-1 text price"><?php echo format_num($row['price']) ?></td>
