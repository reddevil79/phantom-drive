               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                     <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="product_list.php">Products <span class="sr-only"></span></a> </li>
                     ...
                     <div class="col-md-8">
                        <div class="widget">
                           <div class="widget-body">
                              ...
                              <div class="cta">Already registered? <a href="login.php" style="color:#f30;"> Login</a></div>
