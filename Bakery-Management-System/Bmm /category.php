...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8 col-lg-9">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">Category Products</h3>
                            <div class="clearfix"></div>
                        </div>
                        
                        <div class="product-container">
                            <?php
                            // Retrieve the selected category ID from the URL parameter
                            $category_id = isset($_GET['category_id']) ? $_GET['category_id'] : $_SESSION['category_id'];
                            
                            // store the selected category in session
                            $_SESSION['category_id'] = $category_id;
                            
                            $stmt = $db->prepare("SELECT * FROM product_list WHERE category_id = " . $category_id);
                            $stmt->execute();
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-details">
                                    ...
                                    <form method="post" action='category.php?action=add&id=<?php echo $product['product_id']; ?>' class="product-actions">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.quantity-control').forEach(control => {
            ...
            // Ensure the value doesn't go below min when manually changed
